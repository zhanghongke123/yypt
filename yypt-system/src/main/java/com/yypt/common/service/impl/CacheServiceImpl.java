package com.yypt.common.service.impl;
...
public class CacheServiceImpl implements CacheService {
    ...
    @Override
    public void saveCode(String uuid, String code) throws Exception {
        this.redisService.set(YyptConstant.CODE_CACHE_PREFIX + uuid,
                code, (long) yyptProperties.getCodetimeout() * 1000);
    }

    @Override
    public String getCode(String uuid) throws Exception {
        return this.redisService.get(YyptConstant.CODE_CACHE_PREFIX + uuid);
    }
